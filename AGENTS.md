...
- **API-backed screens must render shimmer/skeleton on first-load states** (list/detail/form fetch flows). Do not use spinner-only placeholders for initial content loading.
