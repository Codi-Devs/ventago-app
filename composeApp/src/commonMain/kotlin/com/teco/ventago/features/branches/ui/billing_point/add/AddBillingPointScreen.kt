package com.teco.ventago.features.branches.ui.billing_point.add
...
import com.teco.ventago.features.branches.ui.billing_point.add.viewmodel.AddBillingPointStateUiEvent
import com.teco.ventago.features.branches.ui.billing_point.add.viewmodel.AddBillingPointViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun AddBillingPointScreen(
    viewModel: AddBillingPointViewModel,
    navigateBack: () -> Unit
) {
    ...
    LaunchedEffect(Unit) {
        viewModel.events.collect { event ->
            when (event) {
                AddBillingPointStateUiEvent.GoBack -> navigateBack()
            }
        }
    }
