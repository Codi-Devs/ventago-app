...
data class ItemState(
    ...
    val inventorySectionVisible: Boolean = false,
    val inventoryCanView: Boolean = false,
    val inventoryCanConfigure: Boolean = false,
    val inventoryTracked: Boolean = false,
    val inventoryAvailable: String = "",
    val inventoryAvgCost: String = "",
    val inventoryMinQty: String = "",
    val inventoryNegativePolicyIndex: Int = 0,
    val inventoryProfileVersion: Int = 0,
