...
enum class RealTimeReportCategory(
    ...
    SALES(
        title = "Ventas",
        description = "Facturacion, cobros, productos, vendedores y saldos por cobrar."
    ),
    CUSTOMERS(
        title = "Clientes",
...
object RealTimeReportCatalog {
    ...
    val reports: List<RealTimeReportDefinition> = listOf(
        ...
        RealTimeReportDefinition(
            ...
            category = RealTimeReportCategory.SALES,
            description = "Ranking de productos por monto y cantidad, con porcentaje de participacion en ventas.",
            defaultPreset = "current_month",
            filters = listOf("preset", "start_date/end_date si custom", "document_status=all|valid|canceled"),
            ...
            rows = "Codigo, producto/servicio, categoria, cantidad, montos y % ventas.",
        ...
        RealTimeReportDefinition(
            ...
            defaultPreset = "current_month",
            filters = listOf("preset", "start_date/end_date si custom", "document_status=all|valid|canceled"),
            kpis = listOf("Total vendido", "Cobrado", "Pendiente", "Metodo principal", "Tasa de pago digital", "Documentos"),
            primaryChart = "Barra horizontal primaria monto por metodo.",
            secondaryChart = "Donut secundario distribucion de cobros.",
            rows = "Metodo, transacciones, documentos, total, cobrado, pendiente, ticket promedio y % ventas.",
            notes = listOf("Preferir label del backend y no mostrar tokens tecnicos como etiqueta principal.")
        ),
        RealTimeReportDefinition(
            key = "sales_by_user",
        ...
        RealTimeReportDefinition(
            ...
            category = RealTimeReportCategory.SALES,
            description = "Ranking de sucursales por ventas, cobros pendientes y participacion.",
            defaultPreset = "current_month",
            filters = listOf("preset", "start_date/end_date si custom", "document_status=all|valid|canceled"),
        ...
        RealTimeReportDefinition(
            ...
            title = "Anulaciones y Notas de Credito",
            category = RealTimeReportCategory.SALES,
            description = "Anulaciones, notas de credito, motivos y tendencia de ajustes.",
            defaultPreset = "current_month",
            filters = listOf("preset", "start_date/end_date si custom", "adjustment_type=all|canceled|credit_note", "page", "per_page"),
            kpis = listOf("Total ajustado", "Documentos ajustados", "Total anulado", "Notas de credito", "% de ventas ajustadas", "Usuario principal"),
        ...
        RealTimeReportDefinition(
            ...
            kpis = listOf("Total pendiente", "Total vencido", "Total parcial", "Cliente principal", "Dias vencidos promedio", "Documentos pendientes"),
        ...
        RealTimeReportDefinition(
            ...
            defaultPreset = "current_month",
            filters = listOf("preset", "start_date/end_date si custom", "document_status=all|valid|canceled"),
            kpis = listOf("Total vendido", "Documentos", "Clientes", "Cliente principal", "Concentracion top 5"),
        ...
        RealTimeReportDefinition(
            ...
            isPaginated = true,
            notes = listOf("Si no hay cliente seleccionado, mostrar estado vacio y no consultar.")
        ),
        RealTimeReportDefinition(
            ...
            kpis = listOf("Total pendiente", "Total vencido", "Clientes", "Cliente principal", "Promedio por cliente", "Dias vencidos promedio"),
        ...
        RealTimeReportDefinition(
            ...
            kpis = listOf("Clientes inactivos", "Ventas historicas", "Dias inactivos promedio", "Inactivos con saldo", "Cliente principal"),
        ...
        RealTimeReportDefinition(
            ...
            description = "ITBMS bruto, retenciones, notas de credito e impuesto neto por documento.",
            defaultPreset = "current_month",
            filters = listOf("preset", "start_date/end_date si custom", "include_credit_notes", "page", "per_page"),
            kpis = listOf("Subtotal gravable", "ITBMS bruto", "ITBMS generado", "Retenciones", "Notas de credito", "ITBMS neto", "Total facturado"),
        ...
        RealTimeReportDefinition(
            ...
            secondaryChart = "Linea secundaria Total y Documentos.",
            rows = "Periodo, clave, cantidad, subtotal, ITBMS, total y totales de footer.",
            pdfEndpoint = ReportPdfEndpoint.EXPORT_PDF
        ),
        RealTimeReportDefinition(
            key = "expense_aging",
            title = "Antiguedad de CxP",
            category = RealTimeReportCategory.EXPENSES,
            description = "Cuentas por pagar abiertas, vencidas, parciales y alertas por proveedor.",
            defaultPreset = "all_open",
            filters = listOf("preset=all_open|overdue|due_next_7_days|custom", "start_date/end_date si custom", "aging_bucket", "payment_status", "only_overdue", "only_partial", "currency_code", "page", "per_page"),
        ...
        RealTimeReportDefinition(
            ...
            category = RealTimeReportCategory.EXPENSES,
            description = "Gastos clasificados por cuenta, categoria, clasificacion o proveedor.",
            defaultPreset = "current_year",
            filters = listOf("preset", "start_date/end_date si custom", "group_by=account|category|classification|supplier", "source", "account_kind", "categorization_status", "payment_status", "currency_code"),
            kpis = listOf("Total categorizado", "% categorizado", "Total sin categorizar", "Gastos", "Items", "Categoria principal"),
        ...
        RealTimeReportDefinition(
            ...
            kpis = listOf("Total gastado", "Facturas", "Proveedores", "Proveedor principal", "Concentracion top 5"),
        ...
        RealTimeReportDefinition(
            ...
            defaultPreset = "current_month",
            filters = listOf("preset", "start_date/end_date si custom", "merchant_id", "supplier_ruc", "category_id", "branch_id", "payment_status", "categorization_status", "source", "payment_method", "currency_code", "min_amount", "max_amount", "page", "per_page", "sort_by", "sort_direction"),
        ...
        RealTimeReportDefinition(
            ...
            filters = listOf("preset", "start_date/end_date si custom", "supplier_id", "category_id", "branch_id", "frequency", "payment_status", "currency_code"),
            kpis = listOf("Estimado mensual", "Patrones recurrentes", "Proveedor principal", "Categoria principal"),
        ...
        RealTimeReportDefinition(
            ...
            defaultPreset = "current_month",
            filters = listOf("preset", "start_date/end_date si custom", "group_by=day|week|month|quarter|year", "base=issued|collected", "currency_code"),
            kpis = listOf("Ingresos", "Costos", "Gastos", "Gastos sin categoria", "Utilidad bruta", "Utilidad operativa", "Margen operativo"),
            primaryChart = "Linea multi-serie primaria Ingresos, Gastos y Utilidad.",
        ...
        RealTimeReportDefinition(
            ...
            kpis = listOf("Ingresos actual/anterior", "Variacion de ingresos", "Gastos actual/anterior", "Variacion de gastos", "Utilidad actual/anterior", "Variacion de utilidad"),
        ...
        RealTimeReportDefinition(
            ...
            kpis = listOf("Ingresos", "Gastos", "Utilidad operativa", "Margen operativo", "Variacion de margen"),
            primaryChart = "Linea primaria de margen operativo con eje 0-100%.",
        ...
        RealTimeReportDefinition(
            ...
            defaultPreset = "current_month",
            filters = listOf("preset", "start_date/end_date si custom", "base", "currency_code"),
